...
<head>
    ...
    <title>StudentModel Home</title>
</head>
<body>
    <div class="container">
        <%--student home page--%>
        <form action="/student_home" method="post">
            Student ID: <br><input type="text" name="student_number"> <br>
    ...
    <%--table for grades--%>
    <div class="container signin">
        <%try{  StudentModel student = (StudentModel)request.getAttribute("student");%>

            <%--get the student id and average grade--%>
            <h1><% out.println("Student ID : " + student.getStudent_Number());%></h1><br>
            <h1><% out.println("Average Grade : " + student.getAvgGrade());%></h1>
        ...
        <table style="width:100%">
            ...
            <%--input student grade information--%>
            <%try{%>
