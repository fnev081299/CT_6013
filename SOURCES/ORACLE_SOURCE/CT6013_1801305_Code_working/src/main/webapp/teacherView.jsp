...
<body>
    <div class="container">
        <%--Teacher view form i.e. home page--%>
        <form action="/teacherView" method="post">
            <%--get email to check if in module--%>
            ...
            <%--Submit--%>
            <input type="submit" value="Students" class="grades">
        </form>

        <!--redirect to other pages-->
        <div class="container signin">
            <a href="/teacherViewClass.jsp">Module Passes</a>

            <a href="/teacherViewSpecific.jsp">Module Student Search</a>
            <a href="/addGrade.jsp">Student Grade Updating</a>

            <a href="/login.jsp">Logout</a>
        </div>
    </div>

    <%--table of student grades in module selected--%>
    <div class="container signin">
        <%try{  String module = (String)request.getAttribute("module");%>

        <%--get the module to show user--%>
        <h1><% out.println("Module : " + module);%></h1><br>

        <%--catch possible errors--%>
        <%}catch(Exception e){ out.println("Please enter the information needed");}%>

        <%--table of student results on module--%>
