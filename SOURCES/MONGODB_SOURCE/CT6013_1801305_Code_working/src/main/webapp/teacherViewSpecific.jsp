...
<body>
    <div class="container">
        <%--Viewing the specified student grades for the module selected--%>
        <form action="/teacherViewSpecific" method="post">

            <%--information needed to get the student grades--%>
    ...
    <div class="container signin">
        <a href="/teacherView.jsp">Teacher View</a>
        <a href="/login.jsp">Logout</a>
    </div>

    <%--Viewing the student grades for the module--%>
    <div class="container signin">
